 ...
 *
 * $Id: PlayerClient.java 84 2007-11-25 23:25:15Z veedee $
 *
 */
package javaclient2;
...
//    	} catch (IOException e) { throw new PlayerException (e); }
    ...
    private PlayerDevice requestDeviceAccess (int code, int index, int access) {
        ...
        {
           throw new PlayerException 
              ("[PlayerClient] Requested device " +
               pcu.lookupName ((short)code) + ":" + 
               index + " is not in the device list.");
        }
