/*
 *  Player Java Client 2 - Position3DInterface.java
 ...
 *
 * $Id: Position3DInterface.java 84 2007-11-25 23:25:15Z veedee $
 *
 */
package javaclient2;
...
import javaclient2.structures.PlayerBbox3d;
import javaclient2.structures.PlayerMsgHdr;
import javaclient2.structures.PlayerPose3d;
import javaclient2.structures.position3d.PlayerPosition3dData;
import javaclient2.structures.position3d.PlayerPosition3dGeom;
import javaclient2.structures.position3d.PlayerPosition3dCmdPos;
import javaclient2.structures.position3d.PlayerPosition3dCmdVel;
  ...
  /**
    ...
    public void setPosition (PlayerPose3d pos, PlayerPose3d vel, int state) {
        try {
        	...
        	xdr.xdrEncodeFloat (pos.getPz     ());
        	xdr.xdrEncodeFloat (pos.getProll  ());
        	xdr.xdrEncodeFloat (pos.getPpitch ());
        	xdr.xdrEncodeFloat (pos.getPyaw   ());
        	xdr.xdrEncodeFloat (vel.getPx     ());
        	xdr.xdrEncodeFloat (vel.getPy     ());
        	xdr.xdrEncodeFloat (vel.getPz     ());
        	xdr.xdrEncodeFloat (vel.getProll  ());
        	xdr.xdrEncodeFloat (vel.getPpitch ());
        	xdr.xdrEncodeFloat (vel.getPyaw   ());
    ...
    public void setPosition (PlayerPosition3dCmdPos pp3dcp) {
        try {
        	...
        	XdrBufferEncodingStream xdr = new XdrBufferEncodingStream (48+4);
        	xdr.beginEncoding (null, 0);
        	xdr.xdrEncodeFloat (pp3dcp.getPos ().getPx     ());
        	xdr.xdrEncodeFloat (pp3dcp.getPos ().getPy     ());
        	xdr.xdrEncodeFloat (pp3dcp.getPos ().getPz     ());
        	xdr.xdrEncodeFloat (pp3dcp.getPos ().getProll  ());
        	xdr.xdrEncodeFloat (pp3dcp.getPos ().getPpitch ());
        	xdr.xdrEncodeFloat (pp3dcp.getPos ().getPyaw   ());
        	xdr.xdrEncodeFloat (pp3dcp.getVel ().getPx     ());
        	xdr.xdrEncodeFloat (pp3dcp.getVel ().getPy     ());
        	xdr.xdrEncodeFloat (pp3dcp.getVel ().getPz     ());
        	xdr.xdrEncodeFloat (pp3dcp.getVel ().getProll  ());
        	xdr.xdrEncodeFloat (pp3dcp.getVel ().getPpitch ());
        	xdr.xdrEncodeFloat (pp3dcp.getVel ().getPyaw   ());
    ...
    public void setVelocity (PlayerPose3d vel, int state) {
        try {
        	sendHeader (PLAYER_MSGTYPE_CMD, PLAYER_POSITION3D_CMD_SET_POS, 24+4);
    ...
    public void setVelocity (PlayerPosition3dCmdVel pp3dcv) {
        try {
        	...
        	XdrBufferEncodingStream xdr = new XdrBufferEncodingStream (24+4);
        	xdr.beginEncoding (null, 0);
        	xdr.xdrEncodeFloat (pp3dcv.getVel ().getPx     ());
        	xdr.xdrEncodeFloat (pp3dcv.getVel ().getPy     ());
        	xdr.xdrEncodeFloat (pp3dcv.getVel ().getPz     ());
        	xdr.xdrEncodeFloat (pp3dcv.getVel ().getProll  ());
        	xdr.xdrEncodeFloat (pp3dcv.getVel ().getPpitch ());
        	xdr.xdrEncodeFloat (pp3dcv.getVel ().getPyaw   ());
    ...
    public void setOdometry (PlayerPose3d pose) { 
        try {
        	sendHeader (PLAYER_MSGTYPE_REQ, PLAYER_POSITION3D_SET_ODOM, 24);
        	XdrBufferEncodingStream xdr = new XdrBufferEncodingStream (24);
        	xdr.beginEncoding (null, 0);
        	xdr.xdrEncodeFloat (pose.getPx     ());
        	xdr.xdrEncodeFloat (pose.getPy     ());
        	xdr.xdrEncodeFloat (pose.getPz     ());
        	xdr.xdrEncodeFloat (pose.getProll  ());
        	xdr.xdrEncodeFloat (pose.getPpitch ());
        	xdr.xdrEncodeFloat (pose.getPyaw   ());
        	xdr.endEncoding ();
        	os.write (xdr.getXdrData (), 0, xdr.getXdrLength ());
        	xdr.close ();
        	os.flush ();
